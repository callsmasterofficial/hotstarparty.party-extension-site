const config = {
  ...
  extLink: {
    chrome:
      'https://chrome.google.com/webstore/detail/hotstar-party/inaojcjiaelhcglnajplbnmoijonpnfk',
    firefox: '',
    edge: 'https://microsoftedge.microsoft.com/addons/detail/mdlagkmblemlaijjlopgagmfnoidifpn',
  },
  logo: '/logo.png',
  gtagId: '211267561-42',
  section: {
    first: {
      ...
      html: `
   Hotstar Party is a captivating feature on the Disney Plus platform that allows users to watch their favorite shows, movies, series, and animated videos with friends, irrespective of their distant location. Users must download the Hotstar Party Chrome extension on their compatible devices to access this exciting feature. It includes Windows, macOS, or Chromebook, using a compatible web browser. Plus, a compatible web browser such as Google Chrome or Microsoft Edge. With  <a href="/"><b><u>Hotstar Party</u></b></a>, users can create and join watch parties. And even invite their friends & family to share in the entertainment experience.<br/><br/>
    ...
    second: {
      heading: 'HOW TO HOST A HOTSTAR PARTY?',
      subHeading:
      ...
      accordian: [
        {
          id: 1,
          question: 'How to Download and Install The Hotstar Party Extension?',
          answer:
          ...
          p1: `Search for the Hotstar Party extension there by going to the official Chrome Web Store. You can also click here to download the extension.
            `,
          p2: `Note: You can also use the Microsoft Edge browser to download the extension. Furthermore, the Hotstar Party Extension is compatible with Windows, macOS, and Chromebook devices. 
            `,
          p3: `Click the "ADD TO CHROME" button after that.`,
          p4: `A brief popup will now appear and ask you to confirm your decision to install the extension. Therefore, in order to continue, you must click the "ADD EXTENSION" button.
            `,
          p5: `Additionally, the extension needs to be pinned to the toolbar. If the extension icon isn't visible there, you may also discover it by clicking the puzzle icon in the top-right corner of your browser. The easy steps to install the Hotstar Watch Party extension were these. So, if you carefully follow them, you'll be able to download the extension and sync your watch parties with everyone else on the planet. You still need to understand how to use the extension, too. To learn how to utilize this extension, read on.
        ...
        {
          id: 2,
          question: 'How to Anchor a Hotstar Watch Party using the extension?',
          answer: `Now that you've added the extension to your device let's continue the process further. Be the finest host of online parties by following the instructions listed below. So, have your beverage and popcorn ready.`,
          p1: `Installing and pinning the Hotstar party extension is the first step.`,
          p2: `Additionally, you must access the Hotstar streaming platform and log in with your subscribed account. Ensure that you are logged into your own account.`,
          p3: `Find a video on Hotstar that you want to watch at your watch party now. Also, you can search for the video before playing it.
            `,
          p4: `After that, click the extension icon you already pinned. Here, a window will pop up saying "START A PARTY" and the button "CREATE A WATCH PARTY." In order to create an invitation link, you must click that button.
            `,
          p5: `All that's left to do is invite your pals over for the party of a lifetime by sharing the watch party URL with them. Thus, share the watch party invitation link with your loved ones.
            `,
          p6: `Finally, tap on the invitation URL to join the madness. `,
        },
      ],
    },
    three: {
      heading: 'Stand Apart Features on Hotstar Party',
      subHeading:
      ...
      accordian: [
        ...
        {
          id: 't3',
          question: 'Customize Your Watch Party',
          answer:
        ...
        {
          id: 't4',
          question: 'Control Of The Watch Party',
          answer:
        ...
        {
          id: 't5',
          question: 'Synchronization and High-Resolution Streaming',
          answer:
  ...
  faq: {
    accordian: [
      {
        id: 'f1',
        question: 'What purpose does the Hotstar Party Extension serve?',
        answer:
      ...
      {
        id: 'f2',
        question: 'How can I download and install the Hotstar Party extension?',
        answer:
      ...
      {
        id: 'f3',
        question: 'How many guests are allowed at a Watch Party?',
        answer:
      ...
      {
        id: 'f4',
        question: 'How do I participate in a watch party?',
        answer: `You can join a watch party using the link your friend or watch part host shared with you. In addition, if you haven't already, you must download the watch party extension after clicking the link.`,
        p1: '',
        p2: '',
        p3: '',
        p4: '',
  ...
  footer: {
    ...
    title: "I'm ready, Give me Hotstar Party",
    tags: [
      'Hotstar Party Party',
      'Hotstar Watch Party',
      'Hotstar Party Chrome Extension',
